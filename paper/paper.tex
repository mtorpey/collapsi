...
\abstract{ Collapsi is a two-player game of complete information released in
  ...
  14 plies, and a win can never be forced in fewer than 7 plies.
}
...
i5-13500 processor. All 15~765~750 deals can be enumerated in TODO seconds and
...
Given a particular board, it can be determined whether the current player is in a
...
The author extends his thanks to Ian Gent for guidance on the research and
writing, and to Ben Claydon for some valuable tips on data processing in Rust.
