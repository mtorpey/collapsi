...
\abstract{ Collapsi is a two-player game of complete information released in
  ...
  pawns on a toroidal board of 16 randomly mixed playing cards, players take it
...
grid is toroidal so that the top edge is joined to the bottom, and the left to
